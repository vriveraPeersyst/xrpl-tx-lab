...
export default function PermissionsPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold">Permisos y delegación</h1>
      ...
      <section>
        <h2 className="mb-2 text-lg font-semibold">Permisos granulares ({protocol.permissions.length})</h2>
        <table className="tbl">
