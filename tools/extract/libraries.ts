...
const LIBS: Lib[] = [
  ...
  { id: "xrpl-go", name: "xrpl-go", language: "Go", repo: "XRPLF/xrpl-go", definitions: "binary-codec/definitions/definitions.json", registry: { kind: "go", id: "github.com/XRPLF/xrpl-go" }, docs: "https://pkg.go.dev/github.com/XRPLF/xrpl-go", official: true },
